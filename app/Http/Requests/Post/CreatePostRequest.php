...
class CreatePostRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'account_ids.*'                  => 'integer|exists:social_accounts,id,deleted_at,NULL',
            'variants'                       => 'nullable|array',
            'variants.*.social_account_id'   => 'required_with:variants|integer|exists:social_accounts,id,deleted_at,NULL',
